...
const config = {
  ...
  url: 'https://sartalan.github.io/Wolfsrudel-Herzarmband/',
  ...
  organizationName: 'Wolfsrudel', // Usually your GitHub org/user name.
  projectName: 'Herzarmband', // Usually your repo name.
